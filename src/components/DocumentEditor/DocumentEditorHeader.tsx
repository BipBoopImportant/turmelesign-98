  ...
  return <div className="border-b p-4 bg-card">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2">
          <DocumentDownloader documentId={documentId} documentUrl={documentUrl} fields={fields} signers={signers} documentName={documentName} />
          <Button variant="outline" onClick={onShowShareDialog} disabled={totalSigners === 0} className="flex items-center gap-2">
          ...
          <Button onClick={onSend} disabled={saving || totalSigners === 0 || totalFields === 0}>
